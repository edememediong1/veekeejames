    ...
    <div>
        ...
        <main>
            <article className='w-full p-3 md:w-[80%] m-auto flex flex-col gap-6 items-start leading-8 font-medium text-justify my-20 tracking-tighter'>
                ...
                <p>
                    The bespoke process for Brides begin with a consultation with Veekee James to discuss style ideas, inspiration, budget and the bride’s desires for the dress.    
                </p>
                <p>
