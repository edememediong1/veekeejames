...
const Footer = () => {
  ...
  return (
    <footer className='flex flex-col uppercase md:gap-5 md:justify-start lg:flex-row w-full lg:justify-around lg:h-[30vh] lg:items-center  bg-black text-white p-7 gap-10 text-[13px]'>
